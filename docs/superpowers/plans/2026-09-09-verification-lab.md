...
- [x] Build components/lab workbench, result/receipt, interactive research map and economics. Move existing page to /testnet and scope wallet providers there. Preserve testnet baseline with explicit labeling and opt-in.
